...
class WhiteTextStandard(CardType):
    ...
    def _add_series_count_text_no_season(self, titled_image: Path) -> Path:
        ...
        command = ' '.join([
            ...
            *self.__series_count_text_black_stroke(),
            f'-annotate +0+720 "{self.episode_text}"',
    ...
    def _get_series_count_text_dimensions(self) -> dict:
        ...
        command = ' '.join([
            ...
            *self.__series_count_text_global_effects(),
            f'-annotate +0+0 "{self.separator} "',
            f'-font "{self.SEASON_COUNT_FONT.resolve()}"',
            f'-gravity east',
            *self.__series_count_text_effects(),
            f'-annotate +1600+720 "{self.season_text} "',
            f'-font "{self.EPISODE_COUNT_FONT.resolve()}"',
            f'-gravity center',
            *self.__series_count_text_effects(),
            f'-annotate +0+720 "- "',
            f'-gravity west',
            *self.__series_count_text_effects(),
            f'-annotate +1600+0 "{self.episode_text}"',
            f'null: 2>&1'
        ])
    ...
    def _create_series_count_text_image(self, width: float, width1: float,
        ...
        command = ' '.join([
            ...
            *self.__series_count_text_global_effects(),
            f'-font "{self.SEASON_COUNT_FONT.resolve()}"',
            *self.__series_count_text_black_stroke(),
            f'-annotate +28.5+{height-25} "{self.season_text} "',
            f'-annotate +{width1+441.5+27}+{height-25-10} "{self.separator}"',
            *self.__series_count_text_effects(),
            f'-annotate +28.5+{width1+441.5+27}+{height-25-10} "{self.separator}"',
            f'-annotate +28.5+{height-25} "{self.season_text} "',
            f'-font "{self.EPISODE_COUNT_FONT.resolve()}"',
            *self.__series_count_text_black_stroke(),
            f'-annotate +{width1+441.5+27}+{height-25-10} "-"',
            *self.__series_count_text_effects(),
            f'-annotate +{width1+441.5+27}+{height-25-10} "-"',
            *self.__series_count_text_black_stroke(),
            f'-annotate +{width1+width2+24.5}+{height-25} "{self.episode_text}"',
            *self.__series_count_text_effects(),
            f'-annotate +{width1+width2+24.5}+{height-25} "{self.episode_text}"',
