...
class WhiteTextBroadcast(CardType):
    """
    This class describes lyonza's CardType based on Wvdh's "WhiteTextAbsolute" card to show SxxExx format instead of absolute numbering
    """
    ...
    __GRADIENT_IMAGE = str(RemoteFile('lyonza', 'gradient.png')
